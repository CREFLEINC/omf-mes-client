...
export const lotStatusTransition: Translated<typeof ko.lotStatusTransition> = {
  ...
  release: {
    ...
    remarks: 'Ghi chú',
    confirm: 'Đổi trạng thái và gỡ tạm giữ',
    sectionTitle: 'Thông tin gỡ',
    modeLabel: 'Cách gỡ',
    dialogTitle: 'Gỡ tạm giữ LOT chứ?',
    dialogLot: 'LOT',
    cancel: 'Hủy bỏ',
    release: 'Gỡ tạm giữ',
    reload: 'Tải nội dung mới nhất',
    ...
    impact: {
      infoTitle: 'Thông tin gỡ tạm giữ',
      quantity: 'Số lượng áp dụng',
      location: 'Vị trí áp dụng',
      description: 'Gỡ tạm giữ sẽ bỏ hạn chế xuất kho, xuất hàng và lấy hàng cho số lượng đó.',
      fullQuantity: 'Toàn bộ',
      locationValue: (warehouse: string, location: string): string =>
        `Kho ${warehouse} · Vị trí ${location}`,
      unknown: 'Chưa xác nhận',
      cautionTitle: 'Lưu ý',
      reHold: 'Muốn tạm giữ lại sau khi gỡ thì phải đăng ký mới.',
      shipped: 'Số lượng đã xuất kho sẽ không quay lại kể cả khi gỡ tạm giữ.',
    },
  },
  stale: {
