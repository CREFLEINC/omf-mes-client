...
export const toolUsage = {
  ...
  cumulative: {
     ...
     * 막대 «옆»에 보이는 짧은 이름.
     *
     * ⭐ 이 막대는 「남은 비율」이 아니라 「쓴 비율」이다. 사용 가능 줄에 놓여 있어 이름이 없으면
     * 「사용 가능 499,988 회 · 0%」가 «사용 가능이 0%»로 읽힌다 — 실측으로 그렇게 오해됐다.
     */
    usageBarLabel: '사용률',
  ...
  notice: {
    ...
    /**
     * ⭐ 두 줄로 보인다(사용자 지시 2026-09-15) — 스펙 §3 ④ 한 문장을 「—」 자리에서 나눴다. 말은 그대로다.
     */
    serverAdds: [
      '누계는 저장 시 서버가 더합니다',
      '이 화면은 미리 계산만 합니다.',
