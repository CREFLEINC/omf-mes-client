...
export const packingResult = {
  /*
   * ⭐ **「출하 포장」이다**(설계 「포장 원천 축」 · R73 — `P-02-08` 생산 포장의 짝).
   * ⛔ 종전 「출하 실적 등록」은 **출하 처리(`W-04-04`)·출하 확정(`W-04-12`)과 헷갈린다** —
   *    이 화면이 남기는 것은 상자와 포장 라벨이지 출하 실적이 아니다. 납품 라벨이
   *    `P-04-05` 로 옮겨 간 뒤로는 더 그렇다(사용자 지시 2026-09-17).
   */
  title: '출하 포장',
  panes: {
    scan: '스캔',
