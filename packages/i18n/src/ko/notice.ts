...
export const notice = {
  ...
  scope: {
    ...
    /** ⚠ 선택칸의 이름 **뒤**에 붙는 꼬리다 — 앞 공백까지가 이 값이다. */
    unsupportedSuffix: ' (1차 미지원)',
  ...
  form: {
    ...
    startDate: '시작일',
    endDate: '종료일',
    endDateNote: '게시 상태를 계산하는 필수 날짜입니다.',
   ...
   */
  guard: {
    detailNeedsSelection: '공지를 고르기 전에는 상세를 조회하지 않습니다.',
    ackNeedsSelection: '공지를 고르기 전에는 확인 현황을 조회하지 않습니다.',
  },
