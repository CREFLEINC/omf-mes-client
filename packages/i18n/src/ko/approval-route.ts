/**
 * W-06-15 결재선 정의. 승인 유형은 고정 OpenAPI가 닫은 8개를 사용한다.
 *
...
export const approvalRoute = {
   ...
   */
  guard: {
    detailNeedsSelection: '결재선을 고르기 전에는 상세를 조회하지 않습니다.',
    stepsNeedSelection: '결재선을 고르기 전에는 결재 단계를 조회하지 않습니다.',
  },
  ...
  values: {
     ...
     * 승인 유형과 마찬가지로 계약이 값과 뜻을 함께 못 박았다.
     */
  ...
  actionReasons: {
    /** 주입된 승인 유형 목록이 비어 있을 때의 방어 문구. 기본 목록은 고정 enum으로 채워져 있다. */
    createPendingCode:
      '등록: 승인 유형 목록을 불러오지 못해 새 결재선을 만들 수 없습니다. 이미 있는 결재선은 고치고 끄고 켤 수 있습니다.',
