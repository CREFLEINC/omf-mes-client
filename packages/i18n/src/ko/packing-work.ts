...
export const packingWork = {
  /*
   * ⭐ **설계의 「포장 원천 축」을 이름에 쓴다**(R73 · 규칙 C-07 — 생산 포장 / 출하 포장).
   * 이 화면과 `P-04-01` 은 품목에 따라 갈리는 **배타 분기**이지 같은 일을 하는 두 화면이
   * 아니다. 종전 이름 「포장 작업」·「출하 실적 등록」은 그 관계를 감춰 현장에서 어느 쪽을
   * 여는지 헷갈렸다(사용자 지시 2026-09-17).
   */
  title: '생산 포장',
