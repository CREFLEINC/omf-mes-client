...
export const shopfloorReceipt = {
  ...
  issue: {
    ...
    /*
     * 피킹지시에서 나온 출고가 아니면 작업지시와 도착 위치를 이어받을 곳이 없다. 무엇이
     * 없는지 그 자리에서 말한다 - 앞서 이 자리에 조회 권한 문구가 떠서 사람을 단말 설정으로
     * 보냈다.
     */
    noChain: '이 출고 전표는 작업지시와 도착 위치를 찾을 수 없습니다',
    noChainWhy:
      '피킹지시에서 나온 출고가 아니라 이어받을 곳이 없습니다. 이 화면에서는 받을 수 없습니다.',
