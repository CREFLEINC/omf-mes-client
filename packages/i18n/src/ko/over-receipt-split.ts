...
export const overReceiptSplit = {
  ...
  actions: {
    ...
    createPurchaseOrder: '신규 자재 P/O 등록',
  ...
  actionReasons: {
    ...
    createPurchaseOrderUnavailable:
      '신규 자재 P/O 등록은 여기서 시작하지 않습니다. 초과분 입하를 먼저 등록하면 등록 결과에서 이어집니다.',
  },
  loading: {
  ...
  result: {
     ...
     */
    registerPo: (inboundReceiptNo: string): string => `${inboundReceiptNo} 입하로 자재 P/O 등록`,
  },
  dialog: {
