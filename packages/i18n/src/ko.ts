...
const disposalIssue = {
  ...
  actionReasons: {
    ...
    alreadySubmitted:
      '이미 승인을 요청한 건입니다. 아래 결재 진행에서 어디까지 왔는지 볼 수 있습니다.',
    /**
     ...
     */
    postNeedsSubmission:
      '아직 승인을 요청하지 않은 폐기 요청입니다. 위에서 승인을 요청하고 승인을 받아야 처리할 수 있습니다.',
    /**
   ...
   * 길이 화면에 있어야 한다. **요청 규칙은 발의 자리와 같은 파일에서 나온다**(`reason-draft.ts`) —
