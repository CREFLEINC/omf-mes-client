...
const documentProgress = {
  ...
  detail: {
    ...
    /**
     * 문서를 여는 주소 규약이 아직 없다(화면 ID → 주소 표가 비어 있다).
     * **열기 손잡이를 만들지 않고** 왜 없는지만 밝힌다 — 그럴듯한 주소를 지어 넣으면 사용자가
     * 「열었더니 그 문서가 아닌」 자리에 도착한다.
     */
    openBlocked: '이 문서를 여는 주소가 아직 정해지지 않아 여기서 열 수 없습니다.',
  },
  /**
  ...
  successors: {
    ...
    openBlocked: '후속 문서를 여는 주소가 아직 정해지지 않아 여기서 열 수 없습니다.',
  },
  empty: {
    /**
