 ...
 *
 * **조회 실패 전용이다.** 품의 등록·상신·기타출고 처리(쓰기) 실패는 갈래가 다르고
 * (검증 400 · 권한 403 · 충돌 409 · 응답 없음) 공통 `SaveErrorBanner`가 맡는다 — 그 배선은
 * 뒤따르는 회차에 있다. 둘을 한 부품으로 합치지 않는 이유는 사용자가 할 조치가 다르기 때문이다.
 * 조회 실패는 「다시 시도」로 풀리고, 쓰기 실패는 아니다.
 *
