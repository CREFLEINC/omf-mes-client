 ...
 * 않는다** — 초과 생산은 허용이고, 화면이 할 일은 그 사실을 말하는 것이다(✓확정 QA #27 ·
 * 사용자 결정 2026-09-11).
 */
 ...
 *
 * ⛔ 넘는다고 막지 않는다 — 초과 생산은 확정된 허용이고(✓확정 QA #27), 초과분은 추가 생산LOT
 * 으로 간다. 화면이 하는 일은 **수량 칸 아래에 한 줄 세우는 것**이다.
 *
 * ⚠ 되묻는 팝업의 근거로 `P-02-04` §6 이 적혀 있었으나 고정본의 그 절은 API 매핑이다 —
 *   없는 근거였다. 지금 형태는 사용자 결정(2026-09-11)이다.
 */
