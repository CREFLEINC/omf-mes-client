...
/**
 * 조회 실패 배너 — **갈래마다 사용자가 할 조치가 다르다**(C16).
 *
 * 화면 시험은 500·403 두 갈래에서 제목과 권한 문구, 그리고 **복구 수단이 그 실패가 보이는
 * 자리에 붙는지**를 잰다. 나머지 갈래와 **서버가 빈 문구를 줄 때 공통 안내로 채우는 경로**는
 * 여기서 잰다 — 그 경로가 무너지면 배너가 제목만 있고 본문이 빈 채로 서고, 사용자는 무엇이
 * 막았는지 알 수 없다.
 */
