 ...
 * 초안 파기 확인.
 *
 * **친 값이 확인 없이 사라지지 않게 한다.** 대상을 바꾸거나 조건을 다시 걸면 초안은 뜻을 잃어
 * 비워야 하는데(수명 표 1·3·4·5·12행), 그때 사용자가 방금 넣은 창고·위치·코드가 말없이
 ...
 *
 * **스크림 클릭으로 닫히는 것을 막지 않는다.** 실수로 닫혀도 초안이 그대로 남아 잃는 것이 없다 —
 * 되돌릴 수 없는 제출 확인 창과 갈리는 자리다.
 *
