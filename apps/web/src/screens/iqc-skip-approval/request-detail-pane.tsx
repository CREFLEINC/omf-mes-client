...
/**
 * 줄바꿈이 일어나지 않는 공백(U+00A0). 상자 첫머리에서도 축약되지 않아 **글자로 남는다.**
 *
 * **탈출 문자로 적는다.** 보통 공백과 눈으로 구분되지 않아, 글자를 그대로 적으면 옮겨 쓰거나
 * 편집하는 사이 U+0020으로 바뀌어도 아무도 알아채지 못한다 — 그때 이 파일의 규칙은 통째로
 * 무력해지고 화면은 겉보기에 멀쩡하다. 그 자리를 시험이 코드 포인트로 못 박는다.
 */
