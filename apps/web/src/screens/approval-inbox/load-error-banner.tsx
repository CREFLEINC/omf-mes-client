 ...
 *
 * **오류 코드로 분기하지 않는다.** 계약이 이 화면의 실패를 문장으로만 설명하고 스키마 enum을
 * 두지 않았다 — 서버가 준 메시지를 그대로 낸다.
 */
 ...
 * 권한 없음인가.
 *
 * **목록에 403이 계약에 적혀 있다** — 승인자도 상신자도 아닌 사용자가 남의 요청을 가리키면
 * 그 답이 온다. 이 화면에서는 실제로 도달하는 갈래다.
 */
