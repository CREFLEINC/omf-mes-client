...
export const ApprovalInboxScreen = () => {
   ...
   *
   * **1·2는 지워도 시험이 전부 통과한다**(주입으로 확인했다). 그래도 남기는 이유: 첫째 겹은
   * 둘 다 **렌더 층**이라 창이 사라지는 것이 이 함수보다 늦고, 이 함수는 그 사이 도착한
   * 클릭도 받는다. 되돌릴 수 없는 쓰기에서 그 폭만큼은 값이 있다고 보고 남긴다 —
   * **잣대가 없다는 사실을 여기 적어 두는 것**이 그 대가다. 3·4는 홀로 막으므로 지우면 곧바로 잡힌다.
   */
