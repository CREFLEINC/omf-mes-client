...
export const StocktakingScreen = () => {
   ...
   * | :-: | --- | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
   * | 1 | 조건 변경·조회 | 바뀐다 | **첫 쪽** | **비운다** | **비운다** | **비운다** | 유지 | **비운다** | 비운다 | **닫는다** | 개시 유지 · **마감 비운다** | **비운다** |
   * | 2 | 초기화 | **비운다** | 첫 쪽 | 비운다 | 비운다 | **비운다** | 유지 | 비운다 | 비운다 | **닫는다** | 개시 유지 · **마감 비운다** | 비운다 |
   * | 3 | 쪽 이동 | 유지 | 옮긴 쪽 | **비운다** | **비운다** | **비운다** | 유지 | **비운다** | 비운다 | **닫는다** | 개시 유지 · **마감 비운다** | 비운다 |
   * | 4 | 실사 고르기·해제 | 유지 | **유지** | 넣고 뺀다 | **비운다** | **비운다** | 유지 | **비운다** | 비운다 | **닫는다** | 개시 유지 · **마감 비운다** | **비운다** |
   * | 5 | 위치 고르기·해제 | 유지 | 유지 | 유지 | 넣고 뺀다 | 유지 | 유지 | **비운다** | 비운다 | **닫는다** | 유지 | 유지 |
   * | 6 | **상세가 404** | 유지 | 유지 | **비운다** | **비운다** | **세운다** | 유지 | 비운다 | 비운다 | **닫는다** | 개시 유지 · **마감 비운다** | 비운다 |
   ...
   * - **1~6행이 「개시 유지」인 이유**: 실패는 **그 초안에 대한 사실**이고 개시 초안은 대상이
   *   바뀌어도 살아남는다(1~5행) — 초안은 남는데 그 초안이 왜 거절됐는지만 사라지면 사용자는
   *   같은 값을 그대로 다시 보낸다.
   * - **같은 행에서 마감 실패는 비우는 이유**(리뷰 R-1): 그 근거가 **초안이 있는 쓰기의 것**
   *   이라 마감에는 성립하지 않는다 — 마감에는 초안이 없다(보내는 값이 영업일 하나이고 화면이
   *   파생한다). 남길 이유가 없는데 남으면 실사 A의 「이미 마감된 실사입니다」가 **실사 B의
   *   상세 아래**에 선 채 B의 마감 버튼은 활성이 된다. **치환 실패를 따로 적지 않는 이유**는
   *   그 배너가 `loc` 없이는 그려지지 않는 구획 안에 있어 1~4·6행에서 **구획째 사라지기**
   *   때문이다 — 지우는 자리가 이미 있다는 뜻이지 규칙이 다르다는 뜻이 아니다.
   */
  /*
